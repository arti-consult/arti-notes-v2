...
"[project]/.next-internal/server/app/api/stripe/success/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/stripe/success/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { error: updateError } = await supabase.from("user_onboarding").update({
        ...
        if (updateError) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/error?message=Failed to update payment status", request.url));
        }
        console.log("✅ Payment status updated successfully");
        // Redirect to onboarding
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/onboarding", request.url));
    } catch (error) {
        console.error("🚨 Error in Stripe success handler:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/error?message=Payment processing error", request.url));
    }
}
}}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aad69f6f._.js.map