...
;
const runtime = "edge";
const alt = "SkyAgent - AI-powered agents with Magic UI";
const size = {
    width: 1200,
    height: 630
};
...
async function Image() {
    try {
        ...
        const protocol = ("TURBOPACK compile-time truthy", 1) ? "http" : ("TURBOPACK unreachable", undefined);
...
async function __TURBOPACK__default__export__(props) {
    ...
    function getImageMetadata(imageMetadata, idParam) {
        const data = {
            ...
            url: imageUrl + (idParam ? '/' + idParam : '') + "?51e88c2fd8e732ea"
        };
...
//# sourceMappingURL=_04b398d0._.js.map