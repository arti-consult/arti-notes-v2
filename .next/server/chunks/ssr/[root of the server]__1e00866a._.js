...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ linkTrackingDataToUser(userId) {
    try {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getUserTrackingData(userId) {
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ saveUTMDataDuringOnboarding(userId, onboardingId) {
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getServerUTMData() {
    try {
        const cookieStore = await getCookieStore();
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getServerVisitData() {
    try {
        const cookieStore = await getCookieStore();
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getServerAnonymousId() {
    try {
        const cookieStore = await getCookieStore();
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getServerTrackingData() {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ setServerUTMData(data) {
    try {
        const cookieStore = await getCookieStore();
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ setServerVisitData(data) {
    try {
        const cookieStore = await getCookieStore();
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ setServerAnonymousId(id) {
    try {
        const cookieStore = await getCookieStore();
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ clearServerTrackingCookies() {
    try {
        const cookieStore = await getCookieStore();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1e00866a._.js.map