            ...
            try {
                ...
                if (session?.user) {
                    ...
                    try {
                        ...
                        const { linkTrackingDataToUser } = await __turbopack_context__.r("[project]/src/utils/tracking/server.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
...
"[project]/src/utils/tracking/constants.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/tracking/client.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/tracking/constants.ts [app-ssr] (ecmascript)");
;
function getClientUTMData() {
    try {
        const cookies = document.cookie.split(";");
        const utmData = cookies.find((cookie)=>cookie.trim().startsWith(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UTM_COOKIE_NAME"]}=`));
...
function getClientVisitData() {
    try {
        const cookies = document.cookie.split(";");
        const visitData = cookies.find((cookie)=>cookie.trim().startsWith(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["VISIT_COOKIE_NAME"]}=`));
...
function getClientAnonymousId() {
    try {
        const cookies = document.cookie.split(";");
        const anonymousId = cookies.find((cookie)=>cookie.trim().startsWith(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ANONYMOUS_ID_COOKIE"]}=`));
...
function setClientUTMData(data) {
    try {
        ...
        document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UTM_COOKIE_NAME"]}=${cookieValue}; path=/; max-age=${30 * 24 * 60 * 60}; sameSite=lax${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ""}`;
    } catch (error) {
...
function setClientVisitData(data) {
    try {
        const cookieValue = encodeURIComponent(JSON.stringify(data));
        document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["VISIT_COOKIE_NAME"]}=${cookieValue}; path=/; max-age=${30 * 24 * 60 * 60}; sameSite=lax${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ""}`;
    } catch (error) {
...
function setClientAnonymousId(id) {
    try {
        document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ANONYMOUS_ID_COOKIE"]}=${id}; path=/; max-age=${365 * 24 * 60 * 60}; sameSite=lax${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ""}`;
    } catch (error) {
...
function clearClientTrackingCookies() {
    try {
        document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UTM_COOKIE_NAME"]}=; path=/; max-age=0`;
        document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["VISIT_COOKIE_NAME"]}=; path=/; max-age=0`;
        document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ANONYMOUS_ID_COOKIE"]}=; path=/; max-age=0`;
    } catch (error) {
        console.error("Error clearing client tracking cookies:", error);
    }
}
}}),
"[project]/src/utils/tracking/utm.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getUTMDataFromCookie() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getClientUTMData"])();
}
async function getVisitDataFromCookie() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getClientVisitData"])();
}
...
async function clearTrackingCookies() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearClientTrackingCookies"])();
}
}}),
"[project]/src/components/providers/TrackingProvider.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$utm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/tracking/utm.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/supabase/client.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/tracking/client.ts [app-ssr] (ecmascript)");
"use client";
;
...
function TrackingProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const getOrCreateAnonymousId = async ()=>{
            try {
                let anonymousId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getClientAnonymousId"])();
                if (!anonymousId) {
                    anonymousId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])();
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setClientAnonymousId"])(anonymousId);
                }
            } catch (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const captureTrackingData = async ()=>{
            try {
                const anonymousId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getClientAnonymousId"])();
                if (!anonymousId) return;
                // Capture UTM parameters
                const utmParams = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$utm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["captureUTMParameters"])(searchParams.toString());
                if (Object.keys(utmParams).length > 0) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setClientUTMData"])(utmParams);
                }
                // Capture visit data
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$tracking$2f$utm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["captureVisitData"])();
...
"[project]/src/app/analytics/vercel.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function VercelAnalytics() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$analytics$2f$dist$2f$next$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Analytics"], {}, void 0, false, {
        fileName: "[project]/src/app/analytics/vercel.tsx",
        lineNumber: 6,
        columnNumber: 10
    }, this);
}
}}),
"[project]/src/app/analytics/index.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analytics$2f$vercel$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/analytics/vercel.tsx [app-ssr] (ecmascript)");
;
;
function AnalyticsProvider() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analytics$2f$vercel$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["VercelAnalytics"], {}, void 0, false, {
        fileName: "[project]/src/app/analytics/index.tsx",
        lineNumber: 4,
        columnNumber: 10
    }, this);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$providers$2f$TrackingProvider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/providers/TrackingProvider.tsx [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analytics$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/analytics/index.tsx [app-ssr] (ecmascript)");
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthProvider"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$providers$2f$TrackingProvider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analytics$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AnalyticsProvider"], {}, void 0, false, {
                            fileName: "[project]/src/app/layout.tsx",
                            lineNumber: 24,
                            columnNumber: 13
                        }, this)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aa006ca9._.js.map