...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"4017f1ee2c245e3435c2d9ce91fa88e32e84fe98b9":"completeOnboarding","40408aa358ff3c32694cfde6f469fcf704c3cdfddb":"checkPaymentStatus","40456e47ffa0d243b28358a525af33782f47e31018":"updateProfile"},"",""] */ __turbopack_context__.s({
...
async function completeOnboarding(formData) {
    ...
    try {
        ...
        if (existingOnboarding) {
            ...
            // Insert new record
            const { error } = await supabase.from("user_onboarding").insert(onboardingData);
            onboardingError = error;
        }
        if (onboardingError) {
...
async function checkPaymentStatus(userId) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        const { data, error } = await supabase.from("user_onboarding").select("payment_completed").eq("user_id", userId).single();
...
"[project]/.next-internal/server/app/(auth)/onboarding/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/(auth)/onboarding/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/(auth)/onboarding/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/(auth)/onboarding/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/(auth)/onboarding/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/(auth)/onboarding/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc8adbc2._.js.map