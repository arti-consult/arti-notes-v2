...
"[project]/src/utils/rbac/server.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function hasRole(userId, roleName) {
    ...
    `).eq("user_id", userId).eq("roles.name", roleName);
    if (error) {
...
async function isAtLeastTier(userId, minimumTier) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    const tierLevels = {
        free: 0,
        basic: 1,
    ...
    const hasRequiredTier = data.some((item)=>{
        ...
        const roleLevel = tierLevels[roleName] || -1;
...
async function assignRole(userId, roleName) {
    ...
    const { data: existing, error: existingError } = await supabase.from("user_roles").select("*").eq("user_id", userId).eq("role_id", role.id);
    if (existingError) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/supabase/server.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$rbac$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/rbac/server.ts [app-rsc] (ecmascript)");
...
async function SettingsPage() {
    ...
    const isAdmin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$rbac$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["hasRole"])(user.id, "admin");
    if (!isAdmin) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Manage your OpenAI prompt settings"
                    }, void 0, false, {
                        fileName: "[project]/src/app/admin/settings/page.tsx",
                        lineNumber: 28,
                        columnNumber: 9
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0caa03d5._.js.map