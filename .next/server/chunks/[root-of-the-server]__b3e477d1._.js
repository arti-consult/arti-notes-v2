...
"[project]/.next-internal/server/app/api/onboarding/payment-status/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/onboarding/payment-status/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data, error } = await supabase.from("user_onboarding").select("payment_completed").eq("user_id", userId).maybeSingle(); // Use maybeSingle to handle no records
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3e477d1._.js.map