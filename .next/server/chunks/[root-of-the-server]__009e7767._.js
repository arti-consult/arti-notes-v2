...
"[project]/.next-internal/server/app/api/onboarding/create-checkout/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/utils/stripe/stripe-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
// Initialize Stripe
const stripe = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Stripe"](process.env.STRIPE_SECRET_KEY);
async function createSubscriptionCheckout(userId, priceId, successUrl, cancelUrl) {
    try {
...
async function createCreditPackageCheckout(userId, priceId, successUrl, cancelUrl) {
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createClient"])();
        // Get credit package details
        const { data: creditPackage, error } = await supabase.from("credit_packages").select("*").eq("stripe_price_id", priceId).single();
 ...
 */ async function getOrCreateCustomer(userId) {
    ...
    try {
        ...
        const { data: subscription } = await supabase.from("subscriptions").select("stripe_customer_id").eq("user_id", userId).single();
        ...
        throw new Error(error instanceof Error ? error.message : "Failed to get or create customer");
    }
}
...
"[project]/src/app/api/onboarding/create-checkout/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/supabase/server.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$stripe$2f$stripe$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/stripe/stripe-service.ts [app-route] (ecmascript)");
;
;
;
async function POST(req) {
    try {
        ...
        let priceId = ("TURBOPACK compile-time value", "price_1RFwskFk08c0mcLVw6aS3yBU");
        // Alternatively, get the default plan from database
        if (!priceId) {
            const { data: defaultPlan, error: planError } = await supabase.from("pricing_plans").select("stripe_price_id").eq("is_default", true).single();
        ...
        const origin = req.headers.get("origin") || ("TURBOPACK compile-time value", "http://localhost:3000");
        const successUrl = `${origin}/onboarding?payment=success`;
        const cancelUrl = `${origin}/onboarding?payment=cancelled`;
        const checkoutUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$stripe$2f$stripe$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSubscriptionCheckout"])(userId, priceId, successUrl, cancelUrl);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            url: checkoutUrl
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__009e7767._.js.map