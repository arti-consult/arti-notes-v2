...
"[project]/.next-internal/server/app/api/auth/nylas/callback/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(createClient, "006833ae4a3e4bc312b0517f93af9f917ebef44fad", null);
}}),
"[project]/src/app/api/auth/nylas/callback/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (error) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`/onboarding?error=Calendar connection failed: ${error}`, request.url));
        }
        if (!code) {
            console.error("❌ No authorization code received");
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/onboarding?error=No authorization code received", request.url));
        }
        // Get user ID from session (more reliable than state)
        const { data: { user }, error: userError } = await supabase.auth.getUser();
        if (userError || !user) {
            console.error("❌ User not authenticated:", userError);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/login?error=User not authenticated", request.url));
        }
        const userId = user.id;
        console.log("👤 Processing callback for user:", userId);
        // Exchange code for token
        console.log("🔄 Calling token exchange endpoint...");
        const tokenResponse = await fetch(new URL("/api/auth/nylas/token", request.url), {
            method: "POST",
            headers: {
        ...
        if (!tokenResponse.ok) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`/onboarding?error=Failed to connect calendar: ${errorData.error}`, request.url));
        }
        ...
        if (!grantId) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/onboarding?error=No grant ID received", request.url));
        }
        ...
        const { data: onboarding } = await supabase.from("user_onboarding").select("completed_at").eq("user_id", userId).maybeSingle();
        const redirectPath = onboarding?.completed_at ? "/dashboard" : "/onboarding";
        console.log("🏁 Redirecting to:", redirectPath);
        // Redirect with success message and grant ID
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`${redirectPath}?calendar=connected&grant_id=${grantId}`, request.url));
    } catch (error) {
        console.error("💥 Unexpected error in Nylas callback:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/onboarding?error=An unexpected error occurred", request.url));
    }
}
}}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ffa91db._.js.map