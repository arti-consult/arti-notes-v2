...
"[project]/src/app/admin/analytics/services/vercel-analytics.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "getVercelAnalyticsData": (()=>getVercelAnalyticsData)
});
...
async function getVercelAnalyticsData(projectId, startDate, endDate) {
    const cookieStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cookies"])();
    const vercelToken = cookieStore.get("vercel-token")?.value;
    if (!vercelToken) {
        throw new Error("Vercel token not found");
    }
    const response = await fetch(`${VERCEL_API_URL}/v9/analytics/query?projectId=${projectId}&start=${startDate}&end=${endDate}`, {
        headers: {
    ...
    return {
        ...
        utmParams: data.utmParams?.map((utm)=>({
                source: utm.source,
                medium: utm.medium,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$analytics$2f$services$2f$vercel$2d$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/analytics/services/vercel-analytics.ts [app-client] (ecmascript)");
;
        ...
        "AnalyticsDashboard.useEffect": ()=>{
            async function fetchData() {
                try {
                    ...
                    const analyticsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$analytics$2f$services$2f$vercel$2d$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVercelAnalyticsData"])(("TURBOPACK compile-time value", "prj_r45oSsA35cTUqXuQySjmUObavuVg"), startDate.toISOString(), endDate.toISOString());
...
//# sourceMappingURL=src_6d82bc1f._.js.map