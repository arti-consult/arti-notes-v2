...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('User authenticated, checking calendar connection...', { userId: user.id });
    ...
    console.log('Sync completed successfully', { eventCount: count, error: eventCountError });
